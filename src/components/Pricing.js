  ...
  return (
    <section id="pricing" className="pricing">
      ...
      <div>
        ...
        <div>
          <p>
            <strong>Basis:</strong> 4 uur, 200–300 foto’s, basisbewerking, 1 locatie
          </p>
          <p>
            <strong>Standaard:</strong> 6 uur, 300–500 foto’s, geavanceerde bewerking, 2 locaties
          </p>
          <p>
            <strong>Premium:</strong> 8 uur, 500+ foto’s, volledige evenement, geavanceerde retouching
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <p>
            <strong>Basis:</strong> 4 uur, 2–4 minuten video, basisbewerking, 1 locatie <br />
            *Inclusief 1 revisie.*
          </p>
          <p>
            <strong>Standaard:</strong> 6 uur, 4–6 minuten video, geavanceerde bewerking, 2 locaties, teasers <br />
            *Inclusief 2 revisies.*
          </p>
          <p>
            <strong>Premium:</strong> 8–10 uur, volledige video, dronebeelden, cinematische bewerking <br />
            *Inclusief 2 revisies.*
          </p>
        </div>
      </div>
    ...
    <p>
      <strong>*Voor prijzen of een offerte op maat, neem contact op via de contactpagina.*</strong>        
      </p>
      <p>*Alle prijzen exclusief btw*</p>
